...
### 현재 도장깨기 목록
<li>
  <ul>코드로 배우는 스프링 웹 프로젝트</ul>
  <ul>코드로 배우는 스프링부트 웹 프로젝트</ul>
  <ul><b>모던 자바스크립트 deep dive...ing</b></ul>
</li>

### 예정 도장깨기 책
<li>
  <ul>리액트를 다루는 기술</ul>
  <ul>실전! 스프링 5와 Vue.js 2로 시작하는 모덴 웹 애플리케이션 개발 : 스프링 부트와 Vuex를 활용한 실습 중심의 풀스택 웹 애플리케이션 개발</ul>
</li>
